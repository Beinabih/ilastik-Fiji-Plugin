...
class DataTypes
{
			...
			A extends VolatileAccess >
	{
		...
		public CacheArrayLoader< A > createArrayLoader( final IIlastikHDF5Access hdf5Access );
	}
			...
			new DataType< UnsignedByteType, VolatileUnsignedByteType, VolatileByteArray >()
	{
		...
		@Override
		public CacheArrayLoader< VolatileByteArray > createArrayLoader( final IIlastikHDF5Access hdf5Access )
		{
			return new IlastikVolatileByteArrayLoader( hdf5Access );
		}
	};
			...
			new DataType< UnsignedShortType, VolatileUnsignedShortType, VolatileShortArray >()
	{
		...
		@Override
		public CacheArrayLoader< VolatileShortArray > createArrayLoader( final IIlastikHDF5Access hdf5Access )
		{
			return new IlastikVolatileShortArrayLoader( hdf5Access );
		}
	};
			...
			new DataType< FloatType, VolatileFloatType, VolatileFloatArray >()
	{
		...
		@Override
		public CacheArrayLoader< VolatileFloatArray > createArrayLoader( final IIlastikHDF5Access hdf5Access )
		{
			return new IlastikVolatileFloatArrayLoader( hdf5Access );
		}
	};
}